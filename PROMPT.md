...
Git Flow: branches de feature/_ saem da dev e voltam para a dev; nunca commite direto na main. Commits curtos e descritivos.
Testes: sufixos _.spec.ts (unit), _.integration-spec.ts (integração com banco/serviços reais), _.e2e-spec.ts (e2e via supertest).
